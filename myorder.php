...
<head>
    ...
    <title>Order | JC Restaurant</title>
</head>
<body>
        ...
        <div class="container">
            <nav class="navbar">
                ...
                <ul class="nav-links">
                    ...
                    <li><a href="myorder.php" class="active">ORDER</a></li>
                    <li>
    ...
    <?php
        ...
        $result = mysqli_query($conn, "select * from orders where customer_id = '$customerid' and order_status = 'pending'");
        ...
        ?>
            ...
            <div class="cart-item">
                ...
                <div class="cart-price" style="color: green">
                    <?php echo "Preparing" ?>
                </div>
    ...
    if($count === 0){
            ...
            <h1 style="text-align: center; padding-top: 120px;">You have not yet placed an order.</h1>
        <?php
        }
        ?>
